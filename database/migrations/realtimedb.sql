...
CREATE TABLE `ps_endpoints` (
  ...
  `callerid_privacy` enum ('allowed_not_screened', 'allowed_not_screened', 'allowed_failed_screened', 'allowed_failed_screened', 'allowed', 'prohib_not_screened', 'prohib_passed_screened', 'prohib_failed_screened', 'prohib', 'unavailable') DEFAULT NULL,
