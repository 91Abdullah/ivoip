...
@section('content')
	...
	<div class="m-portlet">
		...
		<!--begin::Form-->
		{!! Form::open(['action' => 'SupervisorController@store', 'method' => 'POST', 'class' => 'm-form m-form--fit m-form--label-align-right m-form--state']) !!}
			<div class="m-portlet__body">
				...
				<div class="form-group m-form__group {{ $errors->has('name') ? 'has-danger' : '' }}">
					{!! Form::label('extension', 'Supervisor ID') !!}
				...
				<div class="form-group m-form__group {{ $errors->has('name') ? 'has-danger' : '' }}">
					{!! Form::label('secret', 'Supervisor Password') !!}
				...
				<div class="form-group m-form__group {{ $errors->has('queue') ? 'has-danger' : '' }}">
					...
					{!! Form::select('queue', App\Queue::pluck('name', 'name'), old('queue'), ['class' => 'form-control m-input']) !!}
					@if($errors->has('queue'))
