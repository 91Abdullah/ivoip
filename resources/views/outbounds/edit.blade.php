			...
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					...
					<h3 class="m-portlet__head-text">
						Edit Outbound Agent: {{ $outbound->name }}	
					</h3>
				</div>
			</div>
		</div>
		<!--begin::Form-->
		{!! Form::model($outbound, ['action' => 'OutboundAgentController@store', 'method' => 'PATCH', 'class' => 'm-form m-form--fit m-form--label-align-right m-form--state']) !!}
