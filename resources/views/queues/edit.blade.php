...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        {!! Form::model($queue, ['action' => ['QueueController@update', 'queue' => $queue->name], 'method' => 'PATCH', 'class' => 'm-form m-form--fit m-form--label-align-right m-form--state']) !!}
        <div class="m-portlet__body">
            ...
            <div class="form-group m-form__group {{ $errors->has('musiconhold') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('musiconhold', old('musiconhold'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('announce') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('announce', old('announce'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('timeout') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('timeout', old('timeout'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('ringinuse') ? 'has-danger' : '' }}">
                ...
                {!! Form::select('ringinuse', ['yes' => 'yes', 'no' => 'no'], old('ringinuse'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('setinterfacevar') ? 'has-danger' : '' }}">
                ...
                {!! Form::select('setinterfacevar', ['yes' => 'yes', 'no' => 'no'], old('setinterfacevar'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('setqueuevar') ? 'has-danger' : '' }}">
                ...
                {!! Form::select('setqueuevar', ['yes' => 'yes', 'no' => 'no'], old('setqueuevar'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('setqueueentryvar') ? 'has-danger' : '' }}">
                ...
                {!! Form::select('setqueueentryvar', ['yes' => 'yes', 'no' => 'no'], old('setqueuevar'), ['class' => 'form-control m-input']) !!}
                <span class="m-form__help">Upon enabling it extra queue variables shall be available.</span>
            ...
            <div class="form-group m-form__group {{ $errors->has('monitor_format') ? 'has-danger' : '' }}">
                ...
                {!! Form::select('monitor_format', ['gsm' => 'gsm', 'wav' => 'wav', 'wav49' => 'wav49'], old('monitor_format'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('membermacro') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('membermacro', old('membermacro'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('membergosub') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('membergosub', old('membergosub'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('queue_youarenext') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('queue_youarenext', old('queue_youarenext'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('queue_thereare') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('queue_thereare', old('queue_thereare'), ['class' => 'form-control m-input']) !!}
                <span class="m-form__help">Voice to be played to caller.</span>
            ...
            <div class="form-group m-form__group {{ $errors->has('queue_callswaiting') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('queue_callswaiting', old('queue_thereare'), ['class' => 'form-control m-input']) !!}
                <span class="m-form__help">Voice to be played to caller.</span>
            ...
            <div class="form-group m-form__group {{ $errors->has('queue_quantity1') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('queue_quantity1', old('queue_quantity1'), ['class' => 'form-control m-input']) !!}
                <span class="m-form__help">Voice to be played to caller.</span>
            ...
            <div class="form-group m-form__group {{ $errors->has('queue_quantity2') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('queue_quantity2', old('queue_quantity2'), ['class' => 'form-control m-input']) !!}
                <span class="m-form__help">Voice to be played to caller.</span>
            ...
            <div class="form-group m-form__group {{ $errors->has('queue_holdtime') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('queue_holdtime', old('queue_holdtime'), ['class' => 'form-control m-input']) !!}
                <span class="m-form__help">Voice to be played to caller.</span>
            ...
            <div class="form-group m-form__group {{ $errors->has('queue_minutes') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('queue_minutes', old('queue_minutes'), ['class' => 'form-control m-input']) !!}
                <span class="m-form__help">Voice to be played to caller.</span>
            ...
            <div class="form-group m-form__group {{ $errors->has('queue_minute') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('queue_minute', old('queue_minute'), ['class' => 'form-control m-input']) !!}
                <span class="m-form__help">Voice to be played to caller.</span>
            ...
            <div class="form-group m-form__group {{ $errors->has('queue_seconds') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('queue_seconds', old('queue_seconds'), ['class' => 'form-control m-input']) !!}
                <span class="m-form__help">Voice to be played to caller.</span>
            ...
            <div class="form-group m-form__group {{ $errors->has('queue_thankyou') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('queue_thankyou', old('queue_thankyou'), ['class' => 'form-control m-input']) !!}
                <span class="m-form__help">Voice to be played to caller.</span>
            ...
            <div class="form-group m-form__group {{ $errors->has('queue_callerannounce') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('queue_callerannounce', old('queue_callerannounce'), ['class' => 'form-control m-input']) !!}
                <span class="m-form__help">Voice to be played to caller.</span>
            ...
            <div class="form-group m-form__group {{ $errors->has('queue_reporthold') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('queue_reporthold', old('queue_reporthold'), ['class' => 'form-control m-input']) !!}
                <span class="m-form__help">Voice to be played to caller.</span>
            ...
            <div class="form-group m-form__group {{ $errors->has('announce_frequency') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('announce_frequency', old('announce_frequency'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('announce_to_first_user') ? 'has-danger' : '' }}">
                ...
                {!! Form::select('announce_to_first_user', ['yes' => 'yes', 'no' => 'no'], old('announce_to_first_user'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('min_announce_frequency') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('min_announce_frequency', old('min_announce_frequency'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('announce_round_seconds') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('announce_round_seconds', old('announce_round_seconds'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('announce_position_only_up') ? 'has-danger' : '' }}">
                {!! Form::label('announce_position_only_up', 'Announce Position only Up') !!}
                {!! Form::select('announce_position_only_up', ['yes' => 'yes', 'no' => 'no'], old('announce_position_only_up'), ['class' => 'form-control m-input']) !!}
                <span class="m-form__help">Only announce the caller's position if it has improved since the last announcement. The default value is no.</span>
                @if($errors->has('announce_position_only_up'))
                    <div class="form-control-feedback">{{ $errors->first('announce_position_only_up') }}</div>
                @endif
            </div>
            <div class="form-group m-form__group {{ $errors->has('announce_holdtime') ? 'has-danger' : '' }}">
                {!! Form::label('announce_holdtime', 'Announce Holdtime') !!}
                {!! Form::select('announce_holdtime', ['yes' => 'yes', 'no' => 'no', 'once' => 'once'], old('announce_holdtime'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('announce_position') ? 'has-danger' : '' }}">
                ...
                {!! Form::select('announce_position', ['yes' => 'yes', 'no' => 'no', 'limit' => 'limit', 'more'], old('announce_position'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('announce_position') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('announce_position_limit', old('announce_position_limit'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('periodic_announce') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('periodic_announce', old('periodic_announce'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('periodic_announce_frequency') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('periodic_announce_frequency', old('periodic_announce_frequency'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('relative_periodic_announce') ? 'has-danger' : '' }}">
                ...
                {!! Form::select('relative_periodic_announce', ['yes' => 'yes', 'no' => 'no'], old('relative_periodic_announce'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('random_periodic_announce') ? 'has-danger' : '' }}">
                ...
                {!! Form::select('random_periodic_announce', ['yes' => 'yes', 'no' => 'no'], old('random_periodic_announce'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('retry') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('retry', old('retry'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('wrapuptime') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('wrapuptime', old('wrapuptime'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('penaltymemberslimit') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('penaltymemberslimit', old('penaltymemberslimit'), ['class' => 'form-control m-input']) !!}
                ...
                @if($errors->has('penaltymemberslimit'))
                    <div class="form-control-feedback">{{ $errors->first('wrapuptime') }}</div>
                @endif
            </div>
            <div class="form-group m-form__group {{ $errors->has('autofill') ? 'has-danger' : '' }}">
                {!! Form::label('autofill', 'Auto Fill') !!}
                {!! Form::select('autofill', ['yes' => 'yes', 'no' => 'no'], old('autofill'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('monitor_type') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('monitor_type', old('monitor_type'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('autopause') ? 'has-danger' : '' }}">
                ...
                {!! Form::select('autopause', ['yes' => 'yes', 'no' => 'no', 'all' => 'all'], old('autopause'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('autopausedelay') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('autopausedelay', old('autopausedelay'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('autopausebusy') ? 'has-danger' : '' }}">
                ...
                {!! Form::select('autopausebusy', ['yes' => 'yes', 'no' => 'no'], old('autopausebusy'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('autopauseunavail') ? 'has-danger' : '' }}">
                ...
                {!! Form::select('autopauseunavail', ['yes' => 'yes', 'no' => 'no'], old('autopauseunavail'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('maxlen') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('maxlen', old('maxlen'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('servicelevel') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('servicelevel', old('servicelevel'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('joinempty') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('joinempty', old('joinempty'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('leavewhenempty') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('leavewhenempty', old('leavewhenempty'), ['class' => 'form-control m-input']) !!}
                <span class="m-form__help">The parameters of the queue "joinempty" and "leavewhenempty" regulate the conditions under which the subscriber can queue and leave it, respectively.</span>
            ...
            <div class="form-group m-form__group {{ $errors->has('memberdelay') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('memberdelay', old('memberdelay'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('weight') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('weight', old('weight'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('timeoutrestart') ? 'has-danger' : '' }}">
                ...
                {!! Form::select('timeoutrestart', ['yes' => 'yes', 'no' => 'no'], old('timeoutrestart'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('defaultrule') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('defaultrule', old('defaultrule'), ['class' => 'form-control m-input']) !!}
            ...
            <div class="form-group m-form__group {{ $errors->has('timeoutpriority') ? 'has-danger' : '' }}">
                ...
                {!! Form::text('timeoutpriority', old('timeoutpriority'), ['class' => 'form-control m-input']) !!}
                <span class="m-form__help">Assign default rules.</span>
