			...
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					...
					<h3 class="m-portlet__head-text">
						Edit Agent: {{ $blended->name }}	
					</h3>
				</div>
			</div>
		</div>
		<!--begin::Form-->
		{!! Form::model($blended, ['action' => ['BlendedAgentController@update', $blended->id], 'method' => 'PATCH', 'class' => 'm-form m-form--fit m-form--label-align-right m-form--state']) !!}
