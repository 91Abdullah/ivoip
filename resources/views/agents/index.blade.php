...
@section('page_sub_title', 'All Agents')

@section('new_record_link', action('AgentController@create'))
		...
		<tbody>
			@foreach($agents as $agent)
				<tr>
					...
					<td>{{ $agent->secret }}</td>
					<td>
						<a href="{{ action('AgentController@edit', $agent->id) }}" class="btn btn-success m-btn m-btn--icon m-btn--icon-only">
