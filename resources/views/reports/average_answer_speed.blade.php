...
@section('page_sub_title', 'Average Answering Speed Report')
...
@section('body')
	...
	<div class="form-group m-form__group row {{ $errors->has('queue') ? 'has-danger' : '' }}">
		...
		<div class="col-lg-4 col-md-9 col-sm-12">
			{!! Form::select('queue', $queues, null, ['class' => 'form-control m-input']) !!}
			@if($errors->has('queue'))
	...
	<table class="table table-custom">
	  	<thead>
	    	<tr>
	      		...
	      		<th>Total Ringtime duration</th>
	      		<th>Average Answering Speed</th>
	    	</tr>
	  	</thead>
	  	<tbody>
	  		<tr>
	  	...
	  	<tfoot>
            <tr>
                <th></th>
                <th></th>
                <th>Total Average Answering Speed: </th>
                <th></th>
            </tr>
        </tfoot>
	</table>
	...
	<script type="text/javascript">
		...
		getReport.onsubmit = function(event) {
			...
			table = $('.table').DataTable({
		        ...
		        paging: false,
		        ajax: {
		        	url: '{!! route('report.average_answering_speed') !!}',
		        	type: 'GET',
		        	data: {
		        		_token: '{!! csrf_token() !!}',
		        		date: dp.val(),
		        ...
		        columns: [
		            ...
		            {data: 'total_ringtime_duration', name: 'total_ringtime_duration'},
		            {data: 'avg_ringtime_duration', name: 'avg_ringtime_duration'}
		        ],
