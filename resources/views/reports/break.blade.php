...
@section('page_sub_title', 'Break Report')
...
@section('body')
    ...
    <table class="table table-custom">
        ...
        {{--<tr>--}}
            {{--<th>Agent</th>--}}
            {{--<th>Agent Name</th>--}}
            {{--@foreach(App\AgentBreak::pluck('name') as $name)--}}
                {{--<th>{{ $name }}</th>--}}
            {{--@endforeach--}}
        {{--</tr>--}}
        {{--</thead>--}}
        {{--<tbody>--}}
        {{--<tr>--}}
            {{--<td colspan="{{ (int)count(App\AgentBreak::pluck('name')) + 2}}" class="text-center">--}}
