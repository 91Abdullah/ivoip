...
@section('page_sub_title', 'Workcode Analysis Report')
...
@section('body')
	...
	<table class="table table-bordered">
	  	<thead>
	    	<tr>
	      		<th rowspan="2">Workcode</th>
	      		<th rowspan="2">Description</th>
	      		<th colspan="4">Talk Time</th>
	...
	<script type="text/javascript">
		...
		getReport.onsubmit = function(event) {
			...
			table = $('.table').DataTable({
		        ...
		        paging: false,
		        ajax: {
		        	url: '{!! route('report.workcode_analysis') !!}',
		        	type: 'GET',
		        	data: {
		        		_token: '{!! csrf_token() !!}',
		        		date: dp.val(),
