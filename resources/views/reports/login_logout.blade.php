...
@section('body')
    ...
    <div class="form-group m-form__group row {{ $errors->has('agent') ? 'has-danger' : '' }}">
        {!! Form::label('agent', 'Select Agent', ['class' => 'col-form-label col-lg-3 col-sm-12']) !!}
        <div class="col-lg-4 col-md-9 col-sm-12">
            {!! Form::select('agent', $agents, null, ['class' => 'form-control m-input']) !!}
            @if($errors->has('agent'))
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <td colspan="4" class="text-center">
                Select Date & Agent to display data.
            </td>
        </tr>
        </tbody>
    </table>
