			...
			<div class="m-portlet m-portlet--mobile m-portlet--body-progress">
				<div class="m-portlet__body text-center">
					<div class="btn-group btn-group-lg" role="group" aria-label="Large button group">
					   	...
					   	<button id="change_mode" type="button" class="btn btn-outline-success">
					   		<span>
								<i class="la la-bullseye"></i>
								<span>Mode</span>
							</span>
					   	</button>
					   	<button id="not_ready_btn" data-toggle="dropdown" type="button" class="btn btn-outline-success dropdown-toggle">
					   		<span>
